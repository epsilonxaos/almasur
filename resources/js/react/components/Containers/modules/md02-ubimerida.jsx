		...
		<Section
			...
			<section className='flex w-full flex-col items-center justify-center gap-y-16 lg:flex-row lg:flex-wrap lg:justify-between'>
				<div className={`${isMobile ? 'px-8' : ''} grid max-w-[400px] gap-8 lg:w-1/3 lg:text-left`}>
					<TextTitle className={`font-aller text-main_b`}>
						<p className='font-geo-700 font-bold'>Ubicado en Mérida, Yucatán.</p>
						<p>
					...
					<TextTitle className='font-aller text-main_b'>
						<p className='font-geo-700 font-bold'>¡Tu corazón pertenece al Sur!</p>
						<p>
							Es también la capital cultural y económica del sureste de México. La Ciudad Blanca es hoy una de las
							entidades con mayores índices de seguridad y calidad de vida en México, comparable con las ciudades más
							seguras del mundo.
				...
				<div className='hidden h-[403px] w-[2px] bg-white lg:flex'></div>
