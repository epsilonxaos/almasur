				...
				<section className='flex flex-col items-center gap-y-8'>
					...
					<TextContent className='flex w-full max-w-[580px] flex-col items-center gap-4'>
						...
						<article className='font-Geomanist-400 flex w-full flex-wrap justify-between'>
							<ul className='border-cnts mx-auto w-full max-w-[291px] border-t-[1px] sm:mx-0 sm:max-w-[259px] sm:border-y-[1px]'>
							...
							<ul className='border-cnts mx-auto w-full max-w-[291px] border-b-[1px] sm:mx-0 sm:max-w-[259px] sm:border-y-[1px]'>
...
const ElementosExtra = ({ children }) => {
	return <li className='border-cnts border-y-[1px] py-2'>{children}</li>
}
