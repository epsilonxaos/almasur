...
export const IconIsotipoComponent = ({ className, fill }) => {
	return (
		<svg
			...
			<g>
				<g>
					<polygon points='39.1,53.2 22.9,26.7 22.9,26.7 22.9,26.7 0,15.8 8,41.6 33.8,56.6 32.3,51.5 37.8,54.2 37.8,54.1 38.8,54.6'/>
				</g>
					<polygon points='62.3,0 45.2,23.4 45.2,23.4 45.2,23.3 49,28.6 46.5,51.9 50,47 50.6,49.9 58.3,31 67.5,26.7 67.5,26.7 67.6,26.5'/>
				<g>
					<polygon points='45.2,23.3 45.2,23.4 45.2,23.4 28.1,0 22.8,26.5 22.9,26.7 32.1,31 39.8,49.9 40.3,47 43.9,51.9 41.3,28.6'/>
				</g>
				<g>
