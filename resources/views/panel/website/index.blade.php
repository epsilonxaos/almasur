        ...
        <tbody>
            @foreach ($casas as $item)
                <tr
                    ...
                    <td class="px-6 py-4">
                        <div class="font-normal text-gray-500">{{ $item->espacios }}</div>
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4">
                        <div class="font-normal text-gray-500">{{ $item->estado == 1? "Activo": "Desactivo" }}</div>
                    </td>
                    <td class="px-6 py-4 text-center w-32">
                        @can([PermissionKey::Admin['permissions']['edit']['name'],
                            ...
                            <a href="{{ route('panel.website.edit', ['id' => $item->id]) }}"
                        ...
                        <form action="{{ route('panel.website.destroy', ['id' => $item->id]) }}" method="post"
